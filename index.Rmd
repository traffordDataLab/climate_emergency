...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Background air pollution |2019 |1 km x 1 km grid square centroids |<a href="https://uk-air.defra.gov.uk/data/laqm-background-maps?year=2018" target="_blank">DEFRA</a> | 2019 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/background_air_pollution.shp" target="_blank">view</a>  |
</div>

```{r fig.retina = 3, fig.cap="Modelled background PM2.5 concentrations in Trafford, 2019"}
