...
|---|---|---|---|---|---|---|
|Carbon dioxide emissions |2005-2024 |Local authority |<a href="https://www.gov.uk/government/collections/uk-local-authority-and-regional-carbon-dioxide-emissions-national-statistics" target="_blank">BEIS, DESNZ</a> | 2026-07-15 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/co2_emissions.csv" target="_blank">view</a> |
</div>

```{r fig.retina = 3, fig.cap="Carbon dioxide emissions by main sector in Trafford, 2024."}
co2_emissions <- read_csv("data/co2_emissions.csv") %>% 
  filter(area_name == "Trafford", period == "2024", sector != "LULUCF") %>%
...
ggplot(data = vertices) + 
  ...
  geom_text(data = layout, aes(x, y), label = paste0(str_wrap(co2_emissions$sector, width = 15), "\n", co2_emissions$percent, "%"), 
            check_overlap = TRUE, color = "#000000", size = 3, fontface = "bold") + 
...
The <a href="http://naei.defra.gov.uk/" target="_blank">National Atmospheric Emissions Inventory</a> (NAEI) website has an <a href="https://naei.energysecurity.gov.uk/emissionsapp/" target="_blank">interactive map</a> that allows you to explore CO<sub>2</sub> emissions by local authority area and sector.
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|CO<sub>2</sub> emissions from large industrial installations |2023 |Point locations |<a href="https://naei.beis.gov.uk/data/map-large-source" target="_blank">NAEI</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/large_point_sources.csv" target="_blank">view</a> |
</div>
...
large_point_sources <- read_csv("data/large_point_sources.csv") %>% 
  ...
  mutate(popup = str_c("<strong>", site, "</strong><br/>",
                       ...
                       "<em>CO<sub>2</sub> emissions (2023): </em>", comma(value), " tonnes") %>%
           map(HTML))

leaflet(width = "100%") %>% 
  setView(lng = -2.330256, lat = 53.421829, zoom = 11) %>% 
      addTiles(urlTemplate = "https://cartodb-basemaps-{s}.global.ssl.fastly.net/light_all/{z}/{x}/{y}.png",
               attribution = '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>, <a href="http://cartodb.com/attributions">CartoDB</a> | <a href="https://www.ons.gov.uk/methodology/geography/licences">Contains OS data © Crown copyright and database right (2026)</a> | Data: <a href="https://naei.beis.gov.uk/data/map-large-source" target="_blank">NAEI</a>') %>% 
  ...
  addControl(paste0("<strong> CO<sub>2</sub> emissions from large industrial installations</strong><br /><em>Trafford, 2023</em>"), position = 'topright')  %>% 
...
Estimates of total industrial & commercial energy consumption are available for 2005 to 2023.

<div class = "metadata">
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Industrial and commercial energy consumption |2023 |Local authority |<a href="https://www.gov.uk/government/collections/total-final-energy-consumption-at-sub-national-level" target="_blank">DESNZ, BEIS</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/non_domestic_energy_consumption.csv" target="_blank">view</a> |
</div>
...
ggplot(industrial_commercial_energy_consumption, aes(x = value, y = group)) +
  ...
  geom_point(colour = "#dd1c77", size = 11) +
  geom_text(aes(label = comma(value, accuracy = 1)), fontface = "bold", colour = "white", size = 4) +
  labs(x = "Thousands of tonnes of oil equivalent (ktoe)", y = NULL, 
       title = "Industrial and commercial fuel use",
       subtitle = paste0(distinct(industrial_commercial_energy_consumption, area_name), ", 2023"),
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Road transport energy consumption |2005-2024 |Local authority |<a href="https://www.gov.uk/government/collections/road-transport-consumption-at-regional-and-local-level" target="_blank">DESNZ, BEIS</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/road_transport_energy_consumption.csv" target="_blank">view</a> |
</div>

```{r fig.retina = 3, fig.cap="Fuel use by vehicle type in Trafford, 2005-2024."}
road_transport_fuel_consumption <- read_csv("data/road_transport_fuel_consumption.csv") %>% 
  filter(area_name == "Trafford") %>% 
  mutate(group = ordered(group, levels = pull(arrange(filter(., period == "2024-01-01"), value),group)))
...
ggplot(road_transport_fuel_consumption,
  ...
  labs(x = NULL, 
       ...
       subtitle = paste0(distinct(road_transport_fuel_consumption, area_name), ", 2005-2024"),
       caption = "Source: DESNZ, BEIS",
       colour = NULL) +
  theme_x() + 
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Domestic energy consumption |2023 |Local authority |<a href="https://www.gov.uk/government/collections/total-final-energy-consumption-at-sub-national-level" target="_blank">DESNZ, BEIS</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/domestic_energy_consumption.csv" target="_blank">view</a> |
</div>

```{r fig.retina = 3, fig.cap="Domestic fuel use in Trafford, 2023."}
...
ggplot(domestic_energy_consumption, aes(x = value, y = group)) +
  geom_segment(aes(x = 0, xend = value, y = group, yend = group), 
               linetype = "dotted", colour = "#212121", size = 0.5) + 
  geom_point(colour = "#DDCC77", size = 11) +
  geom_text(aes(label = comma(value, accuracy = 1)), fontface = "bold", colour = "white", size = 4) +
  labs(x = "Thousands of tonnes of oil equivalent (ktoe)", y = NULL, 
       title = "Domestic fuel use",
       subtitle = paste0(distinct(domestic_energy_consumption, area_name), ", 2023"),
       caption = "Source: DESNZ, BEIS",
       fill = NULL) +
  theme_x() +
  theme(aspect.ratio = 0.5,
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Domestic property build period |pre-1900 to 2025 |Local authority |<a href="https://www.gov.uk/government/collections/valuation-office-agency-council-tax-statistics" target="_blank">VOA</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/domestic_property_build_period.csv" target="_blank">view</a> |
</div>

```{r fig.retina = 3, fig.cap="Domestic property build period in Trafford, pre-1900 to 2025."}
...
ggplot(domestic_property_build_period, 
  ...
  labs(x = NULL, 
       ...
       subtitle = paste0(distinct(domestic_property_build_period, area_name), ", Up to March 2025"),
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|EPCs by Energy Efficiency Rating |2016/Q2 to 2026/Q1 |Local authority |<a href="https://www.gov.uk/government/collections/energy-performance-of-buildings-certificates" target="_blank">MHCLG</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/domestic_epcs_energy_efficiency.csv" target="_blank">view</a> |
</div>
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|EPCs by Environmental Impact Rating |2016/Q2 to 2026/Q1 |Local authority |<a href="https://www.gov.uk/government/statistical-data-sets/live-tables-on-energy-performance-of-buildings-certificates" target="_blank">MHCLG</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/domestic_epcs_environmental_impact.csv" target="_blank">view</a> |
</div>

```{r fig.retina = 3, fig.cap="Cumulative domestic EPCs by Environmental Impact Rating in Trafford, 2016-2026."}
...
ggplot(domestic_epcs_environmental_impact, aes(x = fct_rev(factor(impact)), y = value)) +
  ...
  labs(x = NULL, y = NULL,
       ...
       subtitle = paste0(distinct(domestic_epcs_environmental_impact, area_name), ", 2016/Q2 to 2026/Q1"),
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Fuel poverty |2024 |England |<a href="https://www.gov.uk/government/collections/fuel-poverty-statistics" target="_blank">BEIS</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/fuel_poverty.csv" target="_blank">view</a> |
</div>
...
leaflet(fuel_poverty, width = "100%") %>% 
  ...
  addControl(paste0("<strong>Proportion of households in fuel poverty</strong><br /><em>Trafford's LSOAs, 2024</em>"), position = 'topright') %>% 
  onRender(paste0("function(el, x) {$('head').append(","\'<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\'",");}"))
```
...
**Additional resources**    
The Trafford Data Lab <a href="https://www.trafforddatalab.io/maps/flood_risk_monitor/" target="_blank">Flood Risk Monitor app</a> 
...
|Indicator |Period |Geography |Source |Updated |Licence |Code |
|---|---|---|---|---|---|---|
|Air Quality Management Areas |2026-07 |UK |<a href="https://uk-air.defra.gov.uk/aqma/maps" target="_blank">DEFRA</a> |2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="code/aqma.R" target="_blank">view</a> |
</div>

```{r fig.retina = 3, fig.cap="Air Quality Management Area in Trafford, 2026."}
...
ggplot() + 
  ...
  labs(x = NULL, y = NULL,
       ...
       subtitle = "Trafford, 2026",
       caption = "Contains Ordnance Survey data © Crown copyright and database right 2026\nSource: DEFRA") +
  guides(fill = guide_legend(reverse = TRUE)) +
  coord_sf(datum = NA) +
  theme_x() +
  theme(plot.caption = element_text(size = 8, hjust = 0),
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Background air pollution |2024 |1 km x 1 km grid square centroids |<a href="https://uk-air.defra.gov.uk/data/pcm-data" target="_blank">DEFRA</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/background_air_pollution.shp" target="_blank">view</a>  |
</div>

```{r fig.retina = 3, fig.cap="Modelled background PM2.5 concentrations in Trafford, 2024"}
background_air_pollution <- st_read("data/background_air_pollution.shp", quiet = TRUE) %>% 
  filter(area_name == "Trafford")

ggplot(data = background_air_pollution, 
       aes(fill = pm252024g, color = pm252022g)) +
...
ggplot(roadside_air_pollution, aes(x = date_hour, y = value)) +
  ...
  labs(title = expression(bold(paste("1-hour mean ", NO[2], " concentrations"))),
       subtitle = "Trafford A56 monitoring station, 2025",
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Renewable electricity generation |2014-2024 |Local authority |<a href="https://www.gov.uk/government/statistics/regional-renewable-statistics" target="_blank">BEIS</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/renewable_electricity_generation.csv" target="_blank">view</a> |
</div>

```{r fig.retina = 3, fig.cap="Renewable electricity generation by source in Trafford, 2024."}
renewable_electricity_generation <- read_csv("data/renewable_electricity_generation.csv") %>%
  filter(area_name == id) %>%
  mutate(info = str_c(group, ": ",  comma(value))) %>%
  mutate(valued = as.character(round(value,1)))
# 
...
#        subtitle = paste0(distinct(renewable_electricity_generation, area_name), ", 2024"),
...
`r paste(id, "'s renewable electricity generation in 2024")`

|Technology |MWh |
|:---|:-----|
|`r pull(renewable_electricity_generation , group)[1]` |`r ifelse(is.na(pull(renewable_electricity_generation , valued)[1]),'*',pull(renewable_electricity_generation , valued)[1])` |
|`r pull(renewable_electricity_generation , group)[2]` |`r ifelse(is.na(pull(renewable_electricity_generation , valued)[2]),'*',pull(renewable_electricity_generation , valued)[2])` |
|`r pull(renewable_electricity_generation , group)[3]` |`r ifelse(is.na(pull(renewable_electricity_generation , valued)[3]),'*',pull(renewable_electricity_generation , valued)[3])` |
|`r pull(renewable_electricity_generation , group)[4]` |`r ifelse(is.na(pull(renewable_electricity_generation , valued)[4]),'*',pull(renewable_electricity_generation , valued)[4])` |
|`r pull(renewable_electricity_generation , group)[5]` |`r ifelse(is.na(pull(renewable_electricity_generation , valued)[5]),'*',pull(renewable_electricity_generation , valued)[5])` |
|`r pull(renewable_electricity_generation , group)[6]` |`r ifelse(is.na(pull(renewable_electricity_generation , valued)[6]),'*',pull(renewable_electricity_generation , valued)[6])` |
|`r pull(renewable_electricity_generation , group)[7]` |`r ifelse(is.na(pull(renewable_electricity_generation , valued)[7]),'*',pull(renewable_electricity_generation , valued)[7])` |
|`r pull(renewable_electricity_generation , group)[8]` |`r ifelse(is.na(pull(renewable_electricity_generation , valued)[8]),'*',pull(renewable_electricity_generation , valued)[8])` |
|`r pull(renewable_electricity_generation , group)[9]` |`r ifelse(is.na(pull(renewable_electricity_generation , valued)[9]),'*',pull(renewable_electricity_generation , valued)[9])` |
|`r pull(renewable_electricity_generation , group)[10]` |`r ifelse(is.na(pull(renewable_electricity_generation , valued)[10]),'*',pull(renewable_electricity_generation , valued)[10])` |
|`r pull(renewable_electricity_generation , group)[11]` |`r ifelse(is.na(pull(renewable_electricity_generation , valued)[11]),'*',pull(renewable_electricity_generation , valued)[11])` |

\* Generation was suppressed due to disclosure control
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Onshore wind |2026-03 |Point |<a href="https://www.gov.uk/government/publications/renewable-energy-planning-database-monthly-extract" target="_blank">BEIS</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/onshore_wind.csv" target="_blank">view</a> |
</div>
...
The <a href="https://www.ofgem.gov.uk/environmental-programmes/non-domestic-rhi" target="_blank">Non-domestic Renewable Heat Incentive</a> is a UK Government scheme launched in November 2011 to encourage industry, businesses and public sector organisations to switch to renewable heating technologies. Participants are paid a tariff per unit of energy produced as recorded by an on-site meter over 20 years. The non-domestic RHI closed to new applications in March 2021.

<div class = "metadata">
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Non-domestic Renewable Heat Incentive |2011-11 to 2024-03 |Local authority |<a href="https://www.gov.uk/government/collections/renewable-heat-incentive-statistics" target="_blank">Ofgem</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/non-domestic_rhi.csv" target="_blank">view</a> |
</div>

There have been `r pull(filter(read_csv("data/non-domestic_rhi.csv"),area_name == "Trafford"), value)` non-domestic Renewable Heat Incentive applications accredited in Trafford since the scheme was launched in 2011. This is the final number as the program is closed.

***

## Domestic Renewable Heat Incentive
The <a href="https://www.ofgem.gov.uk/environmental-programmes/domestic-rhi" target="_blank">Domestic Renewable Heat Incentive</a> is a UK Government scheme launched in April 2014 that encourages households to switch from gas and oil-fired boilers to low carbon heating technologies like heat pumps, biomass boilers and solar thermal panels. Financial support is linked to the production of renewable heat with payments received over seven years. The domestic RHI closed to new applications in March 2022.

<div class = "metadata">
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Domestic Renewable Heat Incentive |2011-11 to 2024-03 |Local authority |<a href="https://www.gov.uk/government/collections/renewable-heat-incentive-statistics" target="_blank">Ofgem</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/domestic_rhi.csv" target="_blank">view</a> |
</div>

A total of `r pull(filter(read_csv("data/domestic_rhi.csv"),area_name == "Trafford"), value)` applications have been accredited for payment in Trafford between April 2014 and March 2023. This is the final number as the program is closed.

***

## Boiler Upgrade Scheme (BUS)
The <a href="https://www.ofgem.gov.uk/environmental-and-social-schemes/boiler-upgrade-scheme-bus" target="_blank">Boiler Upgrade Scheme (BUS)</a> is a UK Government scheme opened to voucher applications in May 2022, which contributes upfront capital grants to support the installations of low carbon technologies. These include air source heat pumps (ASHP), ground source heat pumps (GSHP), ground source heat pumps shared ground loops (GSHP SGL) and in some circumstances biomass boilers, in domestic and small non-domestic buildings.

<div class = "metadata">
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Boiler Upgrade Scheme (BUS) |2022/23 to 2025/26 |Local authority |<a href="https://www.gov.uk/government/collections/boiler-upgrade-scheme-statistics" target="_blank">DESNZ, DBEIS</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/domestic_rhi.csv" target="_blank">view</a> |
</div>

```{r fig.retina = 3, fig.cap="Boiler Upgrade Scheme redemptions paid in Trafford, 2022/23 - 2025/26"}
boiler_upgrade_scheme <- read_csv("data/boiler_upgrade_scheme.csv") %>% 
  filter(area_name == "Trafford")

ggplot(boiler_upgrade_scheme, aes(x = factor(period), y = value)) +
  geom_col(fill = "purple", width = .5) +
  geom_hline(yintercept = 0, size = 1, colour = "#212121") +
  scale_y_continuous(labels = comma) +
  labs(x = NULL, 
       y = "Heat pump technologies",
       title = "Boiler Upgrade Scheme redemptions paid",
       subtitle = "Trafford, 2022/23 - 2025/26",
       caption = "Source: DESNZ")  +
  theme_x()
```
`r paste(sum(boiler_upgrade_scheme$value), ' Boiler Upgrade Scheme (BUS) redemptions paid so far in ', id)`
...
ggplot(recycling, aes(x = period, y = value, group = 1)) +
  ...
  labs(x = NULL, y = NULL,
       ...
       subtitle = paste0(distinct(recycling, area_name), ", 2015/16 - 2023/24"),
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Ultra low emission vehicles |2011-2025 |Local authority |<a href="https://www.gov.uk/government/statistical-data-sets/all-vehicles-veh01" target="_blank">Department for Transport </a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/ulev.csv" target="_blank">view</a> |
</div>

```{r fig.retina = 3, fig.cap="ULEVs as a proportion of all licensed vehicles in Trafford, 2011-2025."}
...
ggplot(ulev, aes(x = period, y = percent)) +
  ...
  labs(x = NULL, y = NULL, 
       ...
       subtitle = paste0(distinct(ulev, area_name), ", 2011-2025"),
       caption = "Source: DfT and DVLA") +
  theme_x() +
  theme(axis.title.y = element_text(hjust = 0))
```
`r paste(round(max(ulev$percent)*100,1), '% of all licensed vehicles in ', id, 'are Ultra Low Emissions Vehicles (ULEV) in 2025')`
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Licensed electric vehicles |2011-2025 |Local authority |<a href="https://www.gov.uk/government/statistical-data-sets/all-vehicles-veh01" target="_blank">Department for Transport </a> | 2023-12-13 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/ev.csv" target="_blank">view</a> |
</div>

```{r fig.retina = 3, fig.cap="EVs as a proportion of all licensed cars and vans in Trafford, 2011-2025."}
...
ggplot(ev, aes(x = period, y = percent)) +
  ...
  labs(x = NULL, y = NULL, 
       ...
       subtitle = paste0(distinct(ev, area_name), ", 2011-2025"),
       caption = "Source: DfT and DVLA") +
  theme_x() +
  theme(axis.title.y = element_text(hjust = 0))
```

`r paste(round(max(ev$percent)*100,1), '% of all licensed vehicles in ', id, 'are electric cars and vans in 2025')`

***

## Electric vehicle charging points
Publicly available electric vehicle charging devices at all speeds by local authority per 100,000 population.

<div class = "metadata">
|Indicator |Period |Geography |Source |Updated |Licence |Code |
|---|---|---|---|---|---|---|
|Electric vehicle charging points |Oct 2019 to Apr 2026  |Local authority |<a href="https://www.gov.uk/government/statistical-data-sets/electric-vehicle-charging-infrastructure-statistics-data-tables-evci" target="_blank">Department for Transport</a> |2026-07-14 |<a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank">Creative Commons Attribution-ShareAlike 4.0 International</a> |<a href="code/electric_vehicle_charging_locations.R" target="_blank">view</a> |
</div>

```{r fig.retina = 3}
electric_vehicle_charging_points <- read_csv("data/electric_vehicle_charging_points.csv") 

ggplot(electric_vehicle_charging_points, aes(x = period, y = value)) +
  geom_col(fill = "#FB471E", width = 0.6) +
  geom_hline(yintercept = 0, size = 1, colour = "#333333") +
 # scale_y_continuous(labels = percent_format(accuracy = 0.1)) +
  #scale_x_continuous(breaks=seq(2011,2025, by = 1)) +
  labs(x = NULL, y = "per 100,000 population", 
       title = "Public EV charging devices per 100,000 population",
       subtitle = paste0(distinct(ev, area_name), ", 2020-2026"),
       caption = "Source: DfT") +
  theme_x() 
```

`r paste('At April 2026, there are ', round(max(electric_vehicle_charging_points$value),1), 'publicly available electric vehicle charging devices per 100,000 population  in ', id, '.')`


**Additional resources**    
<a href="https://www.zapmap.com/live" target="_blank">Zapmap</a> allows you to explore electric vehicle charging locations across the UK.
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Cycling |2021-11 - 2023-11 |Local authority |<a href="https://www.gov.uk/government/statistical-data-sets/walking-and-cycling-statistics-cw" target="_blank">Department for Transport</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/cycling.csv" target="_blank">view</a> |
</div>

The Active Lives Survey estimate that in 2023 the proportion of adults who cycled at least once a week was `r round(pull(filter(read_csv("data/cycling.csv"),area_name == "Trafford", frequency == "At least once per week"), value), 1)`%. Other cycling frequencies are shown below:
...
|At least 3 times per week |`r round(pull(filter(read_csv("data/cycling.csv"),area_name == "Trafford", frequency == "At least 3 times per week"), value), 1)` |
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Walking |2021-11 - 2023-11 |Local authority |<a href="https://www.gov.uk/government/statistical-data-sets/walking-and-cycling-statistics-cw" target="_blank">Department for Transport</a> | 2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/walking.csv" target="_blank">view</a> |
</div>

The Active Lives Survey estimate that in 2023 the proportion of adults who walked at least once a week was `r round(pull(filter(read_csv("data/walking.csv"),area_name == "Trafford", frequency == "Once per week"), value), 1)`%. Other walking frequencies are shown below:
...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Green belt |2025-03-31  |England |<a href="https://www.gov.uk/government/collections/green-belt-statistics" target="_blank">Ministry of Housing, Communities & Local Government</a> |2026-07-14 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/green_belt.csv" target="_blank">view</a> |
</div>

The extent of the designated Green Belt in Trafford at 31 March 2025 was estimated at `r comma(pull(read_csv("data/green_belt.csv") %>% filter(area_name == "Trafford", indicator == "Green Belt area"), value))` hectares, or approximately  `r round(pull(read_csv("data/green_belt.csv") %>% filter(area_name == "Trafford", indicator == "Green Belt area"), value)/pull(read_csv("data/green_belt.csv") %>% filter(area_name == "Trafford", indicator == "Total area"), value)*100, 1)`% of the land area of Trafford.     

**Additional resources**    
Green Belt polygon boundaries for local authorities (2026) can be directly downloaded from <a href="https://www.planning.data.gov.uk/dataset/green-belt" target="_blank">data.gov.uk</a>.
