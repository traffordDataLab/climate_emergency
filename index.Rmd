...
library(tidyverse) ; library(scales) ; library(ggsci) ; library(sf) ; library(mapview) ; library(leaflet)
...
m <- mapview(large_point_sources, 
        map.types = "CartoDB.Positron",
        cex = "value",
        col = "#FFFFFF", col.regions = "#636363", alpha.regions = 1,
        layer.name = unique(large_point_sources$site),
        label = unique(large_point_sources$site), legend = FALSE)

m@map %>% setView(lng = -2.330256, lat= 53.421829, zoom = 11)
```
