...
gg <- ggplot(data = background_air_pollution, 
       aes(fill = NO2, color = NO2)) +
  geom_sf(data = la, fill = NA, color = "#212121", size = 0.5) +
  geom_sf_interactive(aes(tooltip = paste0("<em>", round(NO2,0), " µg m-3</em>"), data_id = id), color = NA, alpha = 0.8) +
...
gg <- ggplot(data = background_air_pollution, 
  ...
  geom_sf(data = la, fill = NA, color = "#212121", size = 0.5) +
  geom_sf_interactive(aes(tooltip = paste0("<em>", round(PM10,0), " µg m-3</em>"), data_id = id), color = NA, alpha = 0.8) +
  scale_fill_viridis_c(option = "magma", direction = -1,
                       guide = guide_colorbar(
                         barheight = unit(2, units = "mm"),
                         barwidth = unit(50, units = "mm"),
...
gg <- ggplot(data = background_air_pollution, 
  ...
  geom_sf(data = la, fill = NA, color = "#212121", size = 0.5) +
  geom_sf_interactive(aes(tooltip = paste0("<em>", round(PM2_5,0), " µg m-3</em>"), data_id = id), color = NA, alpha = 0.8) +
  scale_fill_viridis_c(option = "magma", direction = -1,
                       guide = guide_colorbar(
                         barheight = unit(2, units = "mm"),
                         barwidth = unit(50, units = "mm"),
