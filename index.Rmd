...
**Additional resources**    
The Trafford Data Lab <a href="https://www.trafforddatalab.io/maps/flood_risk_monitor/" target="_blank">Floed Risk Monitor app</a> 
...
`r paste(round(max(ev$percent)*100,1), '% of all licensed vehicles in ', id, 'are Ultra Low Emissions Vehicles (ULEV) in 2025')`
***
