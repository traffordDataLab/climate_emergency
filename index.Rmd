...
|Indicator |Period |Geography |Source |Updated |Licence |Data |
|---|---|---|---|---|---|---|
|Cycling |2017-11-15 - 2018-11-15 |Local authority |<a href="https://www.gov.uk/government/statistical-data-sets/walking-and-cycling-statistics-cw" target="_blank">Department for Transport</a> | 2019-07-31 |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |<a href="data/cycling.csv" target="_blank">view</a> |
</div>

**The proportion of adults cycling at least once a week in Trafford in 2017-18 was `r round(pull(filter(read_csv("data/cycling.csv"),area_name == "Trafford", group == "Once per week"), value), 1)`%.**
