...
leaflet(width = "100%") %>% 
  ...
  addCircles(data = large_point_sources, lng = ~lon, lat = ~lat, radius = ~sqrt(value), stroke = TRUE, weight = 1, color = "#FFFFFF", fillColor = "#212121", fillOpacity = 0.7, label = ~popup) %>%
...
ggplot(non_domestic_energy_consumption, aes(x = value, y = group)) +
  ...
  geom_text(aes(label = value), fontface = "bold", size = 4, colour = "white") +
