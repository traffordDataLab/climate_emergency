...
leaflet(height = 600, options = leafletOptions(zoomControl = FALSE)) %>% 
  setView(-3, 54.3, zoom = 6) %>% 
  addTiles(urlTemplate = "",
           attribution = '<a href="https://www.ons.gov.uk/methodology/geography/licences">Contains OS data © Crown copyright and database right (2019)</a> | Data: <a href="https://www.climateemergency.uk">climateemergency.uk</a>') %>%
  ...
  addResetMapButton() %>% 
  addLegend(title = "UK councils declaring a climate emergency",
