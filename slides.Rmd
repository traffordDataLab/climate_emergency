...
cat(paste("The extent of the designated Green Belt in ", id, " in 2019 was estimated at ", comma(pull(green_belt, green_belt_area)), " hectares, or approximately ", pull(summarise(green_belt, percent = round(green_belt_area/total_area*100, 1)),percent), "% of the land area of ", id, "."))
```
